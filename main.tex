...
\makeindex[columns=2, title=keyword index, options= -s resources/styles/indexstyle.ist, intoc]
...
\printbibliography[heading=bibintoc, keyword={online}, title={Online source}]\clearpage
\printbibliography[heading=bibintoc, keyword={image}, title={Picture source}]\clearpage
