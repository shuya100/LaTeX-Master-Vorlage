...
\gradeType{Bachelor/Master of Science (M.Sc.)}
...
\include{chapter/preamble.tex} \clearpage
\include{chapter/abstract.tex} \clearpage
...
\input{chapter/introduction.tex} \clearpage
\input{chapter/background.tex} \clearpage
\input{chapter/analysis.tex} \clearpage
\input{chapter/concept.tex} \clearpage
\input{chapter/technical_design.tex} \clearpage
\input{chapter/implementation.tex} \clearpage
\input{chapter/evaluation.tex} \clearpage
\input{chapter/summary_ perspectives.tex}
\input{chapter/example.tex} \clearpage
